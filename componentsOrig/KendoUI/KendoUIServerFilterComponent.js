...
class KendoUIServerFilterComponent extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.cleartest.addEventListener('click', (event) => {
      ...
      document.getElementById('inputFilterVal').disabled = true;
      document.getElementById('startFilterBtn').disabled = true;
      document.getElementById('clearFilterBtn').disabled = true;
  ...
  startFiltering() {
    ...
    startTimer(this);
    console.log(document.getElementById('inputFilterVal').value)
    ...
    me.gridToTest = new kendo.ui.Grid(document.getElementById("target"),
      {
        ...
        dataBound: function(e) {
          ...
          document.getElementById('inputFilterVal').disabled = false;
