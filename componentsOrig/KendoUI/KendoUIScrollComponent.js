...
class KendoUIScrollComponent extends HTMLElement {
  connectedCallback() {
    ...
    this.cleartest.addEventListener('click', (event) => {
      ...
      document.getElementById('scrollDownVal').disabled = true;
      document.getElementById('scrollUpVal').disabled = true;
      document.getElementById('startScrollBtn').disabled = true;
    ...
    me.gridToTest = new kendo.ui.Grid(document.getElementById("target"),
      {
        ...
        dataBound: function(e) {
          document.getElementById('scrollDownVal').disabled = false;
          document.getElementById('scrollUpVal').disabled = false;
          document.getElementById('startScrollBtn').disabled = false;
          document.getElementById('scrollToEndBtn').disabled = false;
